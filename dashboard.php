...
// le nombre de fille
   $requete3=$base->query("SELECT COUNT(*) AS nbrfille FROM patients WHERE sexe='feminin' AND rolee='nourrisson'");
   $nbrfille=$requete3->fetch();
   // le nombre de femme enceinte
   $requete5=$base->query("SELECT COUNT(*) AS nbrfemme FROM patients WHERE sexe='feminin' AND rolee='femmeEnceinte'");
   $nbrfemme=$requete5->fetch();
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">Femme enceinte</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $nbrfemme['nbrfemme']; ?></h2>
                                
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-female"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
