<?php
   ...
   if(isset($_POST['envoyer']))
   {
     ...
     if(!empty($_POST['nom']) AND !empty($_POST['prenom']) AND !empty($_POST['sexe']) AND !empty($_POST['adresse']) AND
        !empty($_POST['numtelephone']) AND !empty($_POST['age']) AND !empty($_POST['dateNaissance']) AND !empty($_POST['langue']) AND !empty($_POST['rolee']))
        {
          $requete=$base->prepare("INSERT INTO patients(nom,prenom,sexe,adresse,numtelephone,age,
                           ...
                           echo"éffectué avec succès";
                           header("location:listepatient.php");

        }else{
          echo "tous les chanps doivent etre remplis";
        }
   }
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <div class="container">
    <h2 class="text-center mt-3">Formulaire d'ajout de patient</h2>
...
<form method="POST" action="" class="row g-3">
  ...
  <div class="col-12 col-lg-6 position-relative">
    ...
    <input type="text" class="form-control" name="prenom" placeholder="Les prénoms" required>
  </div>
  <div class="col-12 col-lg-6 position-relative">
  ...
  <div class="col-12 col-lg-6 position-relative">
    ...
    <input type="text" class="form-control" name="numtelephone" placeholder="+22995505050" required>
  </div>
  <div class="col-12 col-lg-6 position-relative">
    <label for="age" class="form-label fw-bold mt-2">Age</label>
    <input type="text" class="form-control" name="age" placeholder="Ex:1 mois ou 20 ans" required>
  </div>
  <div class="col-12 col-lg-6 position-relative">
    <label for="dateNaissance" class="form-label fw-bold mt-2">Date de naissance</label>
    <input type="date" class="form-control" name="dateNaissance" placeholder="Date de naissance du patient" required>
  </div>
  <div class="col-12 col-lg-6 position-relative">
