<?php
   ...
   if(isset($_POST['formconnexion']))
   {
      ...
      {
       $requser=$base->prepare("SELECT* FROM agent WHERE mail=? AND mpasse=?");
                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" method="POST" action="" >
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control" name="mpasseconnect" id="mpasse" placeholder="Mot de passe">
                                    </div>
                                    <button class="btn login-form__btn submit w-100" type="submit" name="formconnexion" value="Connexion" id="connexion" style="background-color:#6fd96f ;">Connexion</button>
